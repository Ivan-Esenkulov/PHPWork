...
$MESS["CP_BC_TPL_ENLARGE_PRODUCT_PROP"] = "by property with respect to templates preferences (item sort mode may change)";
$MESS["CP_BC_TPL_ENLARGE_PRODUCT_STRICT"] = "using selected templates (strict)";
...
$MESS["LIST_PRODUCT_BLOCKS_ORDER_TIP"] = "Some blocks may not respect the order due to templates logic. A block may be invisible if it is disabled or unavailable.";
...
$MESS["TOP_PRODUCT_BLOCKS_ORDER_TIP"] = "Some blocks may not respect the order due to templates logic. A block may be invisible if it is disabled or unavailable.";
